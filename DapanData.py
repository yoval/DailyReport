...
##DF_dapan.columns.duplicated().any() 判断重复列   DF_dapan.columns[[0,1]]
...
col = ['日期','业务线','邀评量','邀评率','参评量','参评率','解决量','解决率','24H解决会话量','24h人工客服首次解决率','48H解决会话量','48h人工客服首次解决率','72H解决会话量','72h人工客服首次解决率','好评量','满意度','中评量','中评率','差评量','差评率','进线量','接起量','接起率','平均排队时长','平均响应时长','平均首次响应时长','平均会话时长','平均人工服务时长','15s首响率','30s首响率','60s首响率','15s响应率','60s响应率']
...
DF_dapan = DF_dapan[col]
#DF_dapan.drop(DF_dapan.columns[[0]],axis=1,inplace=True)
DF_dapan = DF_dapan.loc[:,~DF_dapan.columns.duplicated()] #删除重复行
